...
```{r, echo=FALSE, fig.align='center', fig.width=9, fig.height=7.5}
...
hc10bn[, cumAsset:= cumsum(asset)/sum(asset)]
hc10bn[, cumAssetTransform:= cumAsset*max(asset)]

ggplot(hc10bn[1:20], aes(y=asset, x=name)) +
  geom_bar(stat='identity', fill='royalblue') +
  geom_line(aes(x=1:20, y=cumAssetTransform), lty=2, lwd=1.3, col='red') +
  scale_y_continuous(sec.axis = sec_axis(
    ~./hc10bn[, max(asset)], 'Cum. Share of Assets')) +
